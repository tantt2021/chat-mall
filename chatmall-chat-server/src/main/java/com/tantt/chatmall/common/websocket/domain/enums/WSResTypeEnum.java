package com.tantt.chatmall.common.websocket.domain.enums;

import com.tantt.chatmall.common.websocket.domain.vo.res.*;
...
public enum WSResTypeEnum {
    ...
    private static Map<Integer, WSResTypeEnum> cache;

    static {
        cache = Arrays.stream(WSResTypeEnum.values()).collect(Collectors.toMap(WSResTypeEnum::getType, Function.identity()));
    }

    public static WSResTypeEnum of(Integer type) {
